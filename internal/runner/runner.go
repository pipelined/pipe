...
type Message struct {
	...
	Mutators mutable.Mutators // Mutators for pipe.
}
...
func (r Pump) Run(ctx context.Context, take chan mutable.Mutators) (<-chan Message, <-chan error) {
